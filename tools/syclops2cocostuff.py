...
input_dir = '/home/niqbal/git/syclops/output/sugarbeet_syn_v2/main_camera_annotations/semantic_segmentation'
...
#     cv2.imwrite(os.path.join(out_dir, os.path.basename(image_path[:-3]+'png')), color)
    # cv2.waitKey(0)
